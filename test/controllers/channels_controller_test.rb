...
class ChannelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create channel" do
    assert_difference('Channel.count') do
      post channels_url, params: { channel: { about: @channel.about, title: @channel.title } }
    end
  ...
  test "should update channel" do
    patch channel_url(@channel), params: { channel: { about: @channel.about, title: @channel.title } }
